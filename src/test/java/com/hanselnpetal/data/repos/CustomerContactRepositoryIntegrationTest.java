...
public class CustomerContactRepositoryIntegrationTest {
    ...
    public void testFindByEmail() {
		...
		aNewContact.setEmail("fredj@gmail.com");
		
		entityManager.persist(aNewContact);
		
        // Find an inserted record using repository class
        CustomerContact foundContact = customerContactRepository.findByEmail("fredj@gmail.com");
        
        // Assertion
        assertThat(foundContact.getEmail(), is(equalTo("fredj@gmail.com")));
    }	
}
